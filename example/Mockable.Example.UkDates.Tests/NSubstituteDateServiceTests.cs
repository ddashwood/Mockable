...
public class NSubstituteDateServiceTests
{
    ...
    public async Task NoBankHolidaysTest()
    {
        ...
        configurators.BankHolidaysService.GetBankHolidaysAsync().Returns((BankHolidayCollection?)null);
    ...
    public async Task BankHolidayTest()
    {
        ...
        configurators.BankHolidaysService.GetBankHolidaysAsync().Returns(bankHolidays);
